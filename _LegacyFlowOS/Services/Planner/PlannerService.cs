...
using SaaSForge.Api._LegacyFlowOS.Services.Planner.Helpers;
using SaaSForge.Api._LegacyFlowOS.Services.Planner.Models; // AiPlanRequest, UserAiContext, TaskAiContext, DailyPlanAiResult
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Logging;       // ← ensure logging namespace
using System.Diagnostics;
using System.Text.Json;
using SaaSForge.Api.Helpers;
using Task = SaaSForge.Api._LegacyFlowOS.Models.Task;
using SaaSForge.Api._LegacyFlowOS.DTOs.Plan;
using SaaSForge.Api._LegacyFlowOS.Models.Enums;
