        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredTone = table.Column<string>(type: "text", nullable: true),
                    CurrentTone = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanJsonClean = table.Column<string>(type: "text", nullable: true),
                    PlanJsonRaw = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyPlans_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NudgeAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NudgeSentAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastNudgeError = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NudgeSentAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    EndNudgeAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    EndNudgeSentAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastNudgeError = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
